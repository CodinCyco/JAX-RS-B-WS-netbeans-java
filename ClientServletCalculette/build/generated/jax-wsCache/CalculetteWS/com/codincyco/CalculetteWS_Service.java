 ...
 * 
 */
@WebServiceClient(name = "CalculetteWS", targetNamespace = "http://codinCyco.Com/", wsdlLocation = "http://localhost:8080/ApplicationCalculette/CalculetteWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULETTEWS_QNAME = new QName("http://codinCyco.Com/", "CalculetteWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ApplicationCalculette/CalculetteWS?wsdl");
    ...
    public CalculetteWS getCalculetteWSPort() {
        return super.getPort(new QName("http://codinCyco.Com/", "CalculetteWSPort"), CalculetteWS.class);
    }
    ...
    public CalculetteWS getCalculetteWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://codinCyco.Com/", "CalculetteWSPort"), CalculetteWS.class, features);
    }
